...
<!-- Landing cover page -->
	...
	try{
		  ...
		  PreparedStatement ps = conn.prepareStatement("select * from trip where TripNumLikes >= 2");	
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase mr-auto" style="margin-left:30%">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" style="font-size: 12px;" href="credits.jsp">Credits</a></li>
  					<li class="nav-item">
