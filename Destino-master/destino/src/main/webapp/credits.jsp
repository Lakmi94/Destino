...
<p style="color:#fff; text-size:32px; padding-left:10px; padding-right:10px"> Destino is a Web Application that many different people and organisations have contributed towards its development. We at Destino give high regard to those responsible for its developement. </p>
<p style="color:#fff;text-size:32px; padding-left:10px; padding-right:10px">		Various APIs were used for this project's development including 
Leaflet - A JavaScript open source library for mobile-friendly interactive maps. 
MapBox - MapBox is a mapping platform which allows developers to design custom vector maps.                                         Currency - Fixer.io - JSON API is used to obtain real-time currency exchange rates which is updated every 60 seconds.               
Hotels/Flights - Amadeus API - External source for deals of hotels, flights, and suggested packages.
OpenWeatherMap - Free online API for worldwide weather information. It provides efficient weather forecast information which comes with icons for our UX.
HTML Comment box - HTML Comment box plugin allows us to integrate comments for our posts
Amadeus API - Country - YapQ City Name Search by Amadeus is used to get basic country information such as name, code, currency, language,
Places search autofill - Google Places API - This API will be used to search for places while creating or editing a post.           ChatBot - Flow - This API will be used to enable the Chatbot function on the web application                                         Sharing - Twitter API, Facebook API - The Facebook Share Dialog from Facebook SDK for JavaScript gives users the ability to publish

                                                                        
 <a href="contact.jsp"><i>contact us</i></a> or email us at <i>apl.destino@gmail.com</i></p>
</div>
<br>

<div class="col-lg-12 text-center">

				<h2 class="section-heading text-uppercase" style="color:#03ddc7;">Meet The Team</h2>
			</div>
		<div class="container">
